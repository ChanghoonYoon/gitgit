...
# 268 "./mcc_generated_files/system/../uart/uart1.h"
_Bool UART1_IsRxReady(void);
# 277 "./mcc_generated_files/system/../uart/uart1.h"
...
# 306 "./mcc_generated_files/system/../uart/uart1.h"
uint8_t UART1_Read(void);
# 316 "./mcc_generated_files/system/../uart/uart1.h"
...
# 349 "./mcc_generated_files/system/../uart/uart1.h"
...
# 374 "./mcc_generated_files/system/../uart/uart1.h"
...
led_t updateStandbyVals(led_t currentVals)
{
    ...
    if (r == 255 && g < 255 && b == 0 && w == 0)
    {
        currentVals.g++;
    }
    else if (g == 255 && r > 0 && b == 0 && w == 0)
    {
        currentVals.r--;
    }
    else if (g == 255 && b < 255 && r == 0 && w == 0)
    {
        currentVals.b++;
    }
    else if (b == 255 && g > 0 && r == 0 && w == 0)
    {
        currentVals.g--;
    }
    else if (b == 255 && r < 255 && g == 0 && w == 0)
    {
        currentVals.r++;
    }

    else if (b == 255 && r == 255 && w < 255 && g == 0)
    {
        currentVals.w++;
    }
    else if (w == 255 && b > 0 && r > 0 && g == 0)
    {
        currentVals.b--;
        currentVals.r--;
    }

    else if (w == 255 && b == 0 && r < 255 && g == 0)
    {
        currentVals.r++;
    }
    else if (w > 0 && b == 0 && r == 255 && g == 0)
    {
        currentVals.w--;
    }
...
led_t standbyLed = {.r = 255, .g = 0, .b = 0};

void standby(void)
{
    uint8_t index = 0;
    static uint8_t standby_delay_counter = 0;
    static led_t standbyVals[32] = {
        {.r = 255, .g = 0, .b = 0},
        {.r = 255, .g = (uint8_t)(255 * .85), .b = 0},
        {.r = (uint8_t)(255 * .275), .g = 255, .b = 0},
        {.r = 0, .g = (uint8_t)255, .b = (uint8_t)(255 * .57)},
        {.r = 0, .g = (uint8_t)(255 * .57), .b = 255},
        {.r = (uint8_t)(255 * .275), .g = 0, .b = 255},
        {.r = 255, .g = 0, .b = (uint8_t)(255 * .85)},
    };
    dmxData[index++] = STANDBY;
    if (standby_delay_counter < 3)
    {
